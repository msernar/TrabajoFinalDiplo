...
```
```{r}
lda_10 <- LDA(disc_dtm, k = 10, control = list(seed = 1234))  
...
Pareciera que las pruebas tanto con cinco como con diez tópicos no reflejan un sentido tan definido. Las dos visualizaciones anteriores muestran que algunas palabras como "gobierno", "presidente", "fernandez", entre otras, son comunes a más de un tema. Es decir, que los tópicos identificados tienen cierta superposición en términos de palabras. Esto podría deberse a que los documentos en el corpus tratan sobre temas relacionados o tienen un contenido similar. Como alternativa, podríamos considerar los términos que tuvieran la mayor diferencia en β entre todos los temas.
