...
*Nota -\> en el archivo de stopwords agregué la palabra "embed" porque
vi que aparecía en el top10 de minutouno y debe referir a algo de la
página web. Si ves alguna otra palabra para quitar, la agregamos en esa
línea de "tibble"*

### Corrección "años" 

*Nota –\> Agus acá pensé que como la palabra año/años aparece mucho y no
pudimos lematizar, la juntemos en una sola. Ahora se me ocurre que
podríamos eliminar esta palabra como stopword, porque qué aporta?
aparece mucho probablemente hablando de fechas. Que opinás?*
...
*Nota –\> Probé y tampoco logré que funcione la lematización. Volvería
...
*Nota -\> me acordé de haber visto en alguna clase una función para
crear varios gráficos de una. Con ayuda del chat llegué a esto, en la
parte de "grafico" con el código de ggplot podemos jugar con los colores
y demás cuestiones de formato*
...
*Nota -\> Creo que toda esta parte se puede hacer más fácil sacando
directamente el tf después de usar la función bind_tf_idf, pero así lo
habíamos hecho en clase y queda calculado manualmente. Podemos ver si
dejarlo o no.*
